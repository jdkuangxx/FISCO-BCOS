...
contract EntryWapper {   
    ...
    function set(uint256 idx, int256 value) public {
        require(idx >= 0 && idx < fieldSize(), "Index out of range!");
    ...
    function set(uint256 idx, string memory value) public {
        require(idx >= 0 && idx < fieldSize(), "Index out of range!");
        entry.fields[idx] = value;
    }
    function set(uint256 idx, address value) public {
        require(idx >= 0 && idx < fieldSize(), "Index out of range!");
        entry.fields[idx] = cast.addrToString(value);
    }
    function set(uint256 idx, bytes32 value) public {
        require(idx >= 0 && idx < fieldSize(), "Index out of range!");
        entry.fields[idx] = cast.bytes32ToString(value);
    }
    function set(uint256 idx, bytes1[64] memory value) public {
        require(idx >= 0 && idx < fieldSize(), "Index out of range!");
